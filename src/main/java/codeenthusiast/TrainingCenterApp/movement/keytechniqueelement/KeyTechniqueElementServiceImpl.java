...
public class KeyTechniqueElementServiceImpl extends AbstractServiceImpl<KeyTechniqueElement, KeyTechniqueElementDTO>
    ...
    public KeyTechniqueElementServiceImpl(AbstractRepository<KeyTechniqueElement> repository,
                                          AbstractMapper<KeyTechniqueElement, KeyTechniqueElementDTO> mapper,
                                          KeyTechniqueElementsRepository repository1, KeyTechniqueElementMapper mapper1) {
