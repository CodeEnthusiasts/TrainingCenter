...
public class CustomRecordController {
    ...
    @GetMapping(value = "/api/personal-records/{personal_records_id}/custom-records/all")
    ...
    @GetMapping(value = "/api/personal-records/{personal_records_id}/custom-records/three")
    ...
    @PostMapping(value = "/api/personal-records/{personal_records_id}/custom-records")
    ...
    @PatchMapping(value = "/api/custom-records/{custom_record_id}")
    ...
    @DeleteMapping(value = "/api/custom-records/{custom_record_id}")
