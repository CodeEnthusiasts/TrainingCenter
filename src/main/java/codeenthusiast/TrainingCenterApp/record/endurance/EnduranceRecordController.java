...
public class EnduranceRecordController {
    ...
    @GetMapping(value = "/{personal_record_id}/endurance-records/all")
    ...
    @GetMapping(value = "/{personal_record_id}/endurance-records/three")
    ...
    @PostMapping(value = "/{personal_record_id}/endurance-records")
