...
public class EnduranceRecordController {
    ...
    @GetMapping(value = "/api/personal-records/{personal_records_id}/endurance-records/all")
    ...
    @GetMapping(value = "/api/personal-records/{personal_records_id}/endurance-records/three")
    ...
    @PostMapping(value = "/api/personal-records/{personal_records_id}/endurance-records")
    ...
    @PatchMapping(value = "/api/endurance-records/{endurance_record_id}")
    ...
    @DeleteMapping(value = "/api/endurance-records/{endurance_record_id}")
