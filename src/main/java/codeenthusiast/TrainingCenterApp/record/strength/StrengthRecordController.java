...
public class StrengthRecordController {
    ...
    @GetMapping(value = "/personal_records/{personal_records_id}/strength-records/all")
    ...
    @GetMapping(value = "/personal_records/{personal_records_id}/strength-records/three")
    ...
    @PostMapping(value = "/personal_records/{personal_records_id}/strength-records")
